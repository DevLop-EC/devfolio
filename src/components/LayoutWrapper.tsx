...
export default function LayoutWrapper({
  ...
  return (
    <motion.div className="max-w-4xl min-h-screen px-5 mx-auto ">
      <Header />
    ...
    <header className="flex items-center justify-between py-10">
      ...
      <div>
        <Link href="/" aria-label={siteMetadata.headerTitle}>
          ...
          <a className="text-primary-color dark:text-primary-color-dark flex items-center justify-between text-xl font-semibold">
            {`~${router.asPath}`}{' '}
            <Typewriter
              options={{
                strings: [],
